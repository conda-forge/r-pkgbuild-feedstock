...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-pkgbuild-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-pkgbuild-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-pkgbuild-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-pkgbuild-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-pkgbuild-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-pkgbuild-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-pkgbuild` can be installed with:

```
conda install r-pkgbuild
```

It is possible to list all of the versions of `r-pkgbuild` available on your platform with:
